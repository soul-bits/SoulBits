...
import { FileCheck, Shield, Lock, Server, ArrowLeft, Eye, ChevronDown, ChevronUp, FileText, X, Clipboard, Sparkles, AlertCircle, Mail } from 'lucide-react';
    ...
    <section id="services/profile-review" className="py-16 md:py-24 bg-gradient-to-b from-background via-background to-muted/20 min-h-screen">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-20">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-amber-500/10 via-orange-500/15 to-amber-500/10 border-2 border-amber-500/30 rounded-2xl mb-8 shadow-xl shadow-amber-500/5 backdrop-blur-sm"
        >
          <div className="px-6 md:px-8 py-6 md:py-8">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg md:text-xl font-bold text-amber-700 dark:text-amber-400 mb-2">
                  AI-Generated Feedback Disclaimer
                </h3>
                <p className="text-amber-600 dark:text-amber-300 text-sm md:text-base mb-3">
                  This feedback is generated by AI and may contain inaccuracies or mistakes. Please review all suggestions carefully and use your judgment when implementing changes.
                </p>
                <div className="flex items-center gap-2 text-amber-600 dark:text-amber-300 text-sm md:text-base">
                  <Mail className="w-4 h-4" />
                  <span>
                    For questions or feedback about the AI review, please contact us at{' '}
                    <a 
                      href="mailto:sb.soulbits@gmail.com" 
                      className="font-semibold underline hover:text-amber-700 dark:hover:text-amber-200 transition-colors"
                    >
